...
"""This program will ensure that the current enviroment is ready to work with
matplotlib"""
...
def line_demo_dash_control():
    ...
    *Note*: The dash style can also be configured via a
    ...
    line1.set_dashes([3, 3, 3, 3])  # 2pt line, 2pt break, 10pt line, 2pt break
